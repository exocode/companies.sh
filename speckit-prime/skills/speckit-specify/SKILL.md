...
metadata:
  sources:
    - kind: local-file
      path: /Users/janjezek/Coding/spec-kit/templates/commands/specify.md
      attribution: spec-kit
      license: MIT
      usage: embedded
---

Follow the instructions below exactly. This is the canonical `/speckit.specify` command from the local Spec-Kit installation.
